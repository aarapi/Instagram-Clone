...
public class MainActivity extends BaseActivity implements BottomNavigationView.OnNavigationItemSelectedListener, View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        addToRegister(CheckSetup.LocalActions.ANNOYING_PROJECTS_MAIN_ACTIVITY);
    ...
    public void onDataReceive(int action, List<Object> data) {
        ...
        if (action == CheckSetup.LocalActions.ANNOYING_PROJECTS_MAIN_ACTIVITY) {
//            fragmentCurrencyList.onDataRecive(action, data);
    ...
    public int getActivityId() {
        return CheckSetup.LocalActions.ANNOYING_PROJECTS_MAIN_ACTIVITY;
    }
}
