...
public class ListViewAdapterPost extends ArrayAdapter<PostModel> implements View.OnClickListener {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ViewHolder viewHolder; // view lookup cache stored in tag
            ...
            if (getItemViewType(position) == VIEW_TYPE_ITEM) {
                ...
                ViewPagerAdapter viewPagerAdapter = new ViewPagerAdapter(getContext(), dataModel.getLinkImages());
    ...
    public void showBottomSheet(boolean isUserPost) {
